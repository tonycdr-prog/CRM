...
*   **Camera & Image Handling**: Camera capture with automatic image compression (max 1600px, 75% quality JPEG) to reduce upload bandwidth while preserving file metadata.
